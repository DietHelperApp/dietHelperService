...
public class OpenAiGPTService {
    ...
    public String findProducts(List<String> dietBadProducts, String text) {
        ...
        String endPrompt = "Состав:" + text + ". Список аллергенов:" + prompt + ". " +
                "Языки состава и списка аллергенов могут отличаться. " +
                "Напиши только в ответе через запятую аллергены из списка, которые содержатся в данном составе, на языке, " +
                "на котором они написаны в списке.";
